...
# --- Microstrip transmission-line synthesis lives in tests/test_microstrip_line.py ---
#
# microstrip_effective_permittivity, microstrip_characteristic_impedance_ohm,
# and microstrip_synthesize_width_m (issue #286) live in
...
# FBW = (VSWR-1)/(Q*sqrt(VSWR)) (see module docstring in
# rf_tools/patch_synthesis.py for the source and why this form was chosen
# over the simpler FBW=1/Q).
...
# rf_tools/patch_synthesis.py (NOT a settled textbook-precise formula -- see
