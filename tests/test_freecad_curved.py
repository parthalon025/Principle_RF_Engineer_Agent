...
def test_run_freecad_fem_mesh_geometry_passes_mesh_max_size_through(tmp_path: Path):
    ...
    macro_path_holder: dict[str, Path] = {}
    ...
    macro_path_holder["macro"] = Path(result["macro_file"])
    assert "mesh_obj.CharacteristicLengthMax = 0.00025" in macro_path_holder["macro"].read_text()
