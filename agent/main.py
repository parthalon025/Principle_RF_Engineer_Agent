...
ROLE_SPECS: list[RoleSpec] = [
    ...
    RoleSpec(
        ...
        domain_note=(
            ...
            "IP3/IM3 linearity. Also gets (issue #57) run_ngspice_simulation "
            "and run_xyce_simulation -- free/open circuit-level SPICE "
    ...
    RoleSpec(
        ...
        domain_note=(
            ...
            "only), and (issue #57) ngspice/Xyce (run_ngspice_simulation, "
