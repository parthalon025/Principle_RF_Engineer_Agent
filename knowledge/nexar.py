...
def _post_graphql(query: str, part_number: str, access_token: str) -> dict[str, Any]:
    ...
    hard-coding. Posts via the shared knowledge.sourcing_common.post_json
    helper (issue #280) rather than a second, module-local Request/urlopen/
    json.loads copy -- factored out so that difference doesn't require
    copying the surrounding request-building boilerplate a second time."""
