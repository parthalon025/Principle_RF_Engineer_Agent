...
REFLECTED_IN_PHASE = EffectProfile(
    ...
    scoring_quantity_note=(
        ...
        "returns a phase at all -- rf_tools.patch_synthesis returns a patch resonant "
...
LOW_INFRARED_EMISSIVITY = EffectProfile(
    ...
    family_gap=FamilyGap(
        ...
        misfiling_cost=(
            ...
            "SHORTS IT OUT. rf_tools.sheet_impedance.min_overlay_sheet_resistance_"
            ...
            "(rf_tools.sheet_impedance.sheet_resistance_ohm_sq, likewise VERIFIED by "
